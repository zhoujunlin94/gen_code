...
import io.github.zhoujunlin94.code.gen.constant.ServiceConstant;
...
public class GenServiceCodeComponent extends AbstractGenCodeComponent {
    ...
    protected Map<String, Object> buildBindingMap(Table table, Setting context) {
        ...
        retMap.put(CommonConstant.PACKAGE_NAME, context.get(ServiceConstant.PACKAGE_NAME_KEY));
    ...
    protected String getDestFileName(Setting context) {
        String destPath = buildDestPath(context, context.get(ServiceConstant.PACKAGE_NAME_KEY));
        FileUtil.mkdir(destPath);
        String serviceName = context.get(ServiceConstant.SERVICE_NAME);
        return destPath + StrUtil.SLASH + serviceName + StrUtil.DOT + CommonConstant.JAVA;
    }
